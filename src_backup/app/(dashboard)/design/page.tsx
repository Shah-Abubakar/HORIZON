    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        <div className="w-16 h-16 rounded-2xl bg-accent-primary/15 flex items-center justify-center mx-auto mb-6">
          <Brush size={28} className="text-accent-highlight" />
        </div>
        <h1 className="text-3xl font-bold text-white mb-3">Design Blueprint</h1>
        <p className="text-accent-primary-dark max-w-md mx-auto mb-6">
          Learn how to design without a designer using AI. Prompt library, color palettes, and UI generators.
        </p>
