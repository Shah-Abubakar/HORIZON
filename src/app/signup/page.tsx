  ...
  return (
    <div className="min-h-screen bg-dark-900 flex items-center justify-center p-6">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="gradient-orb light w-[500px] h-[500px] -top-32 -right-32" />
        <div className="gradient-orb grey w-[400px] h-[400px] bottom-0 left-0" />
      </div>
      ...
      >
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <p className="text-accent-primary-dark mb-8">Start building with AI today</p>
